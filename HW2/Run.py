...
sim1 = Simulation.Simulation(7,8, 1,2, 1000, 1,4)
sim1.startSim("1")
'''
...
sim2 = Simulation.Simulation(7,8, 3,5, 100, 1,2)
sim2.startSim("2")
'''
...
sim3 = Simulation.Simulation(7,8, 1,2, 1000, 1,5)
sim3.startSim("3")
'''
...
sim4 = Simulation.Simulation(2,5, 4,10, 1000, 5,8)
sim4.startSim("4")
'''
